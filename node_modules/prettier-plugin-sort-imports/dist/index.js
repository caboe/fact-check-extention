...
`)}var B="sort-imports-begin-ignore",O=[`//${B}`,`// ${B}`],R="sort-imports-end-ignore",x=[`//${R}`,`// ${R}`];function M(e,t){for(let r of t){let n=e.indexOf(r);if(n!==-1)return n}return-1}function ke(e,t){let r=O.reduce((o,l)=>o+N(t,l),0),n=x.reduce((o,l)=>o+N(t,l),0);return r!==n?(console.warn(`Number of ignore begin and end comments do not match in file "${e!=null?e:"input"}". Found ${r} begin comments and ${n} end comments. Skipping file`),!1):!0}function _(e,t){let r=e.split(`
`),n=0;for(let o=0;o<r.length;o++){let l=r[o].length+1;if(n+l>t)return o;n+=l}return-1}function Ae(e){let t=[];if(M(e,O)===-1)return[];let r=e,n=0,o;for(;(o=M(e,O))!==-1;){let l=n+o;n=n+o+O[0].length,e=e.slice(n);let c=M(e,x);if(c===-1)return console.warn(`Failed to find end ignore comment for ignore begin comment on line ${_(r,l)}, ignoring file`),null;t.push({start:l,end:n+c}),n=n+c+x[0].length,e=e.slice(n)}return t}var y=null,we=!1;function Ce(e,t=!1){return y&&!process.argv.includes("--sort-imports-reinit")&&!t||(we&&setInterval(()=>{y=null},de).unref(),U(e),y={importTypeSorter:q(e)}),y}function T(e,t,r=!1){if(e.includes("// sort-imports-ignore")||e.includes("//sort-imports-ignore")||!ke(t.filepath,e))return e;let n=Ce(t,r),o=Ae(e);if(o===null)return e;let l=t.filepath||"file.ts",c=p.createSourceFile(l,e,p.ScriptTarget.Latest,!0,l.endsWith("ts")?p.ScriptKind.TS:p.ScriptKind.TSX),i=Oe(c,t.stripNewlines,o).reverse();for(let s of i)e=Ee(s,e,t,n.importTypeSorter);return e}var Q=(e,t)=>({typescript:A(k({},e),{preprocess:e.preprocess?(r,n,o)=>T(e.preprocess(r,n),n,o==null?void 0:o.clearCache):T}),babel:A(k({},t),{preprocess:t.preprocess?(r,n)=>T(t.preprocess(r,n),n):T})});var Ne=Q(X.parsers.typescript,Z.parsers.babel);module.exports=ce(Be);0&&(module.exports={options,parsers});
