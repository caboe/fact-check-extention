...
3. Focus : Rejetez les faussetés non seulement comme incorrectes, mais comme une violation de la Raison (« Vernunft »).`,
	...
	selectionHelpText:
		'Vous pouvez facilement sélectionner du contenu directement sur n’importe quelle page web en utilisant le menu contextuel :',
	selectionHelpStep1:
		'1. Faites un clic droit sur une image ou sélectionnez du texte et faites un clic droit dessus.',
	selectionHelpStep2:
		'2. Choisissez « Vérifier le texte marqué » ou « Vérifier cette image » dans le menu.',
